...
#same_hierarchy = os.path.join(same_hierarchy,'Gungnir_loveesm_EXT')#debug
...
def text_cnv():
	...
	txt = txt.replace(r';SCR_A0440Z_END', 'bgmstop:dwavestop -1:skipoff:mov %200,1:bgmonce "bgm\\Led_a.ogg":bg "image\\ed1_ayaka.png",10:click:bgmstop:dwavestop -1:csp -1:reset')#ED1
	#選択肢7
	...
	txt = txt.replace(r';SCR_B0640Z_END', 'bgmstop:dwavestop -1:skipoff:mov %201,1:bgmonce "bgm\\Led_a.ogg":bg "image\\ed2_ayaka.png",10:click:bgmstop:dwavestop -1:csp -1:reset')#ED2
	#選択肢9
	...
	txt = txt.replace(';SCR_C0700Z_END', 'tati_reset:csp -1:bgmstop:dwavestop -1:skipoff:mov %202,1:bgmonce "bgm\\Led_s.ogg":bg "image\\ed3_harem.png",10:click:bgmstop:dwavestop -1:csp -1:reset')#ED3
